...
export default async function ProductDetails({ params }: { params: Promise<{ id: string }> }) {
 ...
 {/* Back Link */}
 <Link href="/catalog" className="inline-flex items-center text-sm text-gray-500 hover:text-brand-primary mb-8 transition-bookzen">
 ...
 <div className="relative w-64 h-[400px] md:w-80 md:h-[500px] shadow-2xl rounded-bookzen overflow-hidden hover:scale-105 transition-transform duration-500">
 <Image
 src={book.coverImage}
 alt={book.title}
 fill
 ...
 <div className="flex items-center space-x-1 text-brand-secondary mb-4">
 ...
 <p className="text-xl text-gray-500 mb-6">By <span className="text-brand-primary font-medium hover:underline cursor-pointer transition-bookzen">{book.author}</span></p>
 ...
 <span className="w-2 h-2 rounded-full bg-brand-secondary mr-2" />
