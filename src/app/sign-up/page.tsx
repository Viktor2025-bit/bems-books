    ...
    <div className="min-h-screen pt-24 pb-20 flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold font-jost text-primary">Create Account</h1>
          <p className="text-gray-500 mt-2">Join Bems Books and start reading today</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href="/sign-in" className="text-highlight font-medium hover:underline">
            Sign In
          </Link>
        </p>
      </motion.div>
