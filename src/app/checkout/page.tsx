...
export default function CheckoutPage() {
 ...
 // Fulfillment is now handled securely via Webhook (/api/webhook)
 // The frontend just provides immediate feedback
 setIsSuccess(true);
 clearCart();
 },
 onCancel: () => {
 ...
 <div className="w-20 h-20 bg-brand-secondary/20 text-brand-secondary rounded-full flex items-center justify-center mb-6">
